                                ...
                                <form action="users" method="post" class="card-body personal-info">
                                    ...
                                    <div class="mb-4 d-flex align-items-center justify-content-between">
                                        <h5 class="fw-bold mb-0 me-4">
                                            <span class="d-block mb-2">Update User</span>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="usernameInput" name="username" placeholder="Username"  value="${userToEdit.username}" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control" id="passwordInput" name="password" placeholder="Password" value="${userToEdit.password}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="firstNameInput" name="firstName" placeholder="First Name"  value="${userToEdit.firstName}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-user"></i></div>
                                                <input type="text" class="form-control" id="lastNameInput" name="lastName" placeholder="Last Name" value="${userToEdit.lastName}" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" id="mailInput" name="email" placeholder="Email" value="${userToEdit.email}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <label class="flex items-center space-x-2">
                                                <input type="checkbox" name="isManager" value="true" ${userToEdit.isManager ? 'checked' : ''}>
